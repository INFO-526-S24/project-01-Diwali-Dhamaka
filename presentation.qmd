...
df.Q1 <- df |>
  mutate(
    ...
    Product_Category = case_when(
     Product_Category %in% c("Footwear & Shoes") ~ "Clothing & Apparel",
    ...
    # Refactorizes the marital status to detail the meaning(Kaggle)
    Marital_Status = case_when(
      Marital_Status %in% 0 ~ "Married",
      Marital_Status %in% 1 ~ "Single"
    )
  )
...
# Plot Q2 data
ggplot(data = df.Q2, aes(x = Age_Group, y = log10(Total), fill = Gender)) +
  geom_boxplot()
